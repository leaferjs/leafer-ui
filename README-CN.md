...
[![GitHub Release](https://img.shields.io/github/v/release/leaferjs/leafer-ui)](https://github.com/leaferjs/leafer-ui/releases) [![GitHub License](https://img.shields.io/github/license/leaferjs/leafer-ui)](https://github.com/leaferjs/leafer-ui/blob/main/LICENSE)
...
```sh
npm install leaferjs

# 需使用插件时，推荐同时安装跨平台核心包，防止出现更新版本不同步问题
npm install leaferjs @leaferjs/core @leaferjs/draw
```

图形交互：

```ts
import { Leafer, Rect } from 'leaferjs'
...
[在线体验图形编辑](https://www.leaferjs.com/examples/#official%2Fplugin%2Feditor%2Fframe%2Ftransparent.ts)。

## 💼 商业支持与可持续性

从“一个引擎”到“一个成熟产品”之间存在巨大的研发鸿沟。为了支持开源引擎的长久维护，并协助企业跨越底层开发瓶颈，我们构建了透明且健康的生态：
...
- **良性循环与长期主义：** 所有的商业收入将用于反哺开源引擎的持续迭代，确保 LeaferJS 始终代表 Web 图形技术的领先水平。

## 🌟 参与贡献：五年沉淀，始于初心

LeaferJS 是一个持续打磨了五年的开源引擎。我们致力于把“图形系统底座”这件事标准化，让开发者专注产品创意，而非底层实现。

**如果你支持原创、追求极致性能，请为我们点亮一颗 Star！**

<div style="display:flex; gap: 12px">
<a target="_blank" href="https://github.com/leaferjs/leaferjs" aria-label="github"  rel="noopener">
...
[每一位贡献代码的社区成员](https://github.com/leaferjs/leaferjs/graphs/contributors)
...
[leaferjs](https://github.com/leaferjs/leaferjs) UI 表现层仓库。
