...
export { IMultiKeyframe, IKeyframe, IKeyframeId, IAnimateEasing, IAnimateDirection, IAnimateEnding, IAnimateEvents, IAnimateEventFunction, IAnimateKeyframe, IComputedKeyframe, IAnimation, IAnimateOptions, IAnimate, IStates, IStateName } from './type/IAnimation'
