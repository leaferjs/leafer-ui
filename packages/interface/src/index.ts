...
export { IKeyframes, IKeyframe, IKeyframeId, IAnimateEasing, IAnimateDirection, IAnimateEnding, IAnimateKeyframe, IAnimation, IAnimateOptions, IAnimate, IStates, IStateName } from './type/IAnimation'
