...
export { IAnimation, ITransition, IAnimate, IKeyframe, IKeyframeId, IAnimateEasing, IAnimateEasingFunction, IAnimateEasingName, IAnimateDirection, IAnimateEnding, IAnimateEvents, IAnimateEventFunction, IAnimateKeyframe, IComputedKeyframe, IStyleAnimation, IKeyframesAnimation, IAnimateOptions } from './IAnimation'
