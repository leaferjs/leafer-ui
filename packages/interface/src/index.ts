...
export { IKeyframes, IKeyframe, IKeyframeId, IAnimationEasing, IAnimationDirection, IAnimationEnding, IAnimationKeyframe, IAnimationData, IAnimationOptions, IAnimation, IStates, IStateName } from './type/IAnimation'
