...
export { IKeyframes, IKeyframe, IKeyframeId, IEasingType, ITimelineKeyframe, IAnimationData, IAnimationOptions, IAnimation, IStates, IStateName } from './type/IAnimation'
