...
export { IMultiKeyframe, IKeyframe, IKeyframeId, IAnimateEasing, IAnimateEasingName, IAnimateDirection, IAnimateEnding, IAnimateEvents, IAnimateEventFunction, IAnimateKeyframe, IComputedKeyframe, IAnimation, IAnimateOptions, IAnimate, IStates, IStateName } from './type/IAnimation'
