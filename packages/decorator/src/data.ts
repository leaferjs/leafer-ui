...
export function effectType(defaultValue?: __Value) { return (target: IUI, key: string) => effectType__(target, key, defaultValue) }
export function effectType__(target: IUI, key: string, defaultValue?: __Value) {
