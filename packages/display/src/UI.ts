...
export class UI extends Leaf implements IUI { // tip: rewrited Box
    ...
    public animate(_keyframe?: IUIInputData | IKeyframe[] | IAnimation, _options?: IAnimateOptions | IAnimateEasingName | number | boolean, _isTemp?: boolean): IAnimate {
