...
export class UI extends Leaf implements IUI { // tip: rewrited Box
    ...
    @dataType()
    public animation?: IAnimationData
    ...
    public animate(_keyframes: IKeyframes | IAnimationData, _options?: IAnimationOptions): IAnimation { return undefined }
