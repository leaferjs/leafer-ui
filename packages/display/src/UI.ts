...
export class UI extends Leaf implements IUI { // tip: rewrited Box
    ...
    public animate(_keyframes: IKeyframes | IAnimation, _options?: IAnimateOptions | number): IAnimate { return undefined }
